...
typedef enum WICED_SPI_SS_MODE
{
    /// Slave select normal
    WICED_SPI_SS_NORMAL,
...
enum
{
    ...
    WICED_INPUT_PIN_PULL_UP   = 0x0400,
...
///
/// Please note that the SPI pin selection must be done using
