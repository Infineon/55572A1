...
enum wiced_bt_ble_isoc_event_e
{
    ...
    WICED_BLE_ISOC_PERIPHERAL_CLOCK_ACCURACY,  /**< Peripheral Clock Accuracy */
...
typedef struct
{
    ...
    uint16_t                    acl_handle;             /**< ACL Connection Handle */
    uint16_t                    cis_conn_handle;        /**< CIS Connection Handle */
    uint8_t                     cis_id;                 /**< CIS Connection Handle */
    ...
    wiced_bt_ble_isoc_phy_t     phy_c_to_p;             /**< The transmitter PHY of packets from the central */
    wiced_bt_ble_isoc_phy_t     phy_p_to_c;             /**< The transmitter PHY of packets from the peripheral */
...
/** ISOC Peer Peripheral Clock Accuracy data */
typedef struct
{
    uint8_t        status;                       /**< PCA Status */
    uint16_t       acl_handle;                   /**< ACL Connection Handle */
    wiced_bt_device_address_t peer_bda;          /**< Peer Bluetooth Address */
    uint8_t        pca;                          /**< Peripheral Clock Accuracy value */
}wiced_ble_isoc_pca_t;

typedef struct
{
    uint8_t status;                 /**< Data path Status */
    uint16_t cis_connection_handle; /**< CIS Connection Handle  */
} wiced_ble_isoc_data_path_status_t;
...
typedef union
{
    ...
    wiced_ble_isoc_pca_t                    pca_data;               /**< Peripheral Clock Accuracy */
    wiced_ble_isoc_cis_disconnect_data_t    cis_disconnect;         /**< CIS Disconnect  */
    wiced_ble_isoc_data_path_status_t       datapath_status;        /**< Data Path Status (setup/remove) */
...
typedef struct
{
    ...
    uint8_t                     peripheral_clock_accuracy;  /**< Peripheral Clock Accuracy */
 ...
 *
 */
wiced_result_t wiced_ble_isoc_set_cig_param(wiced_bt_ble_cig_param_t *cig_params, void *ctx);
 ...
 *
 */
wiced_result_t wiced_ble_isoc_set_cig_param_test(wiced_bt_ble_cig_param_test_t *cig_params, void *ctx);
 ...
 *                  Peripheral should call this API on receiving WICED_BLE_ISOC_CIS_REQUEST event in registered application callback
 *
 * @param[in]       cis_handle  : CIS handle
 *
 * @return      status
...
/**
 *
 * Function         wiced_ble_isoc_request_peer_pca
 *
 *                  Request for Peripheral Clock Accuracy
 *
 * @param[in]       peer_bda  : Peer Bluetooth Address
 *
 * @return      status
 *
 *  Note : WICED_BLE_ISOC_PERIPHERAL_CLOCK_ACCURACY event will be received in registered application callback.
 */
wiced_result_t wiced_ble_isoc_request_peer_pca(wiced_bt_device_address_t peer_bda);
