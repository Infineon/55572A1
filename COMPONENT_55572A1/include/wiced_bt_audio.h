 ...
 *
 * Callback invoked if specific SCO data route was set
 * This gets invoked when the application want to get SCO voice data
 *
 * @param ltch_len      : sco data length in bytes
 *        p_data        : sco voice data
 *
 */
 ...
 *
 * @param[in]      sco_data_route : WICED_SCO_ROUTE_NONE/WICED_SCO_ROUTE_APP
 * @param[in]      p_data_cb      : callback function to be invoked when receiving sco rx data
 *
 * @return          void
 *
 */
 ...
 * @param[in]      p_pcmsrc  : microphone pcm source
