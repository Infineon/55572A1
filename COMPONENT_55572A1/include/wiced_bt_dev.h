...
#endif // ifndef BTM_BLE_SCAN_TYPE
...
#endif // ifndef BTM_PM_STATUS_CODES
...
enum wiced_bt_management_evt_e
{
    ...
    BTM_LPM_STATE_LOW_POWER,                        /**< Bluetooth device wake has been deasserted. Used for Host Stack Use Case. */
...
#endif // ifndef BTM_MANAGEMENT_EVT
...
#endif // ifndef BTM_BLE_ADVERT_MODE
 ...
 *              WICED_FALSE: fail
 */
extern wiced_bool_t wiced_bt_utils_acl_connect(wiced_bt_device_address_t remote_bd_addr);
 ...
 *              WICED_FALSE: fail
 */
extern  wiced_bool_t wiced_bt_utils_acl_start_authentication(wiced_bt_device_address_t bdaddr, uint16_t hci_handle);
 ...
 *              WICED_FALSE: fail
 */
extern wiced_bool_t wiced_bt_utils_acl_start_encryption(wiced_bt_device_address_t bdaddr);
 ...
 *                  0xffff for invalid
 */
uint16_t wiced_bt_dev_get_acl_conn_handle(wiced_bt_device_address_t remote_bda, wiced_bt_transport_t transport);
 ...
 *
 * @param[in]      disable    : TRUE to disable smp over br, FALSE to enable
 *
 * @return          void
 *
 */
