...
*/
#define WICED_BT_GATT_ENCRYPED_MITM WICED_BT_GATT_ENCRYPTED_MITM
#define WICED_BT_GATT_ENCRYPED_NO_MITM WICED_BT_GATT_ENCRYPTED_NO_MITM
...
wiced_bt_gatt_status_t wiced_bt_gatt_server_send_read_by_type_rsp (uint16_t conn_id,
    wiced_bt_gatt_opcode_t opcode,
    uint8_t type_len,
    uint16_t data_len, uint8_t* p_data, wiced_bt_gatt_app_context_t p_app_ctxt);
