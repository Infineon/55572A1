...
#	print $OUT "*/\n";
	...
	if($param->{layout} eq 'code_from_top') {
        ...
        print $OUT "\tapp_iram_begin = app_iram_data_begin;\n";
    }

	print $OUT "\tapp_iram_length = . - app_iram_begin;\n";
	print $OUT "\tapp_iram_bss_length = app_iram_bss_end - app_iram_bss_begin;\n";
	print $OUT "\tapp_iram_data_length = app_iram_data_end - app_iram_data_begin;\n";
	print $OUT "\tapp_irom_data_begin = app_iram_data_begin;\n";
