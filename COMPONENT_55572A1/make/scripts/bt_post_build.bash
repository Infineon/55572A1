...
GEN_APP_SS_BIN_COMMAND="${CYWICEDTOOLS}/IntelHexToBin/IntelHexToBin -u $(printf 0x%x $((${DS_LOCATION} - 1))) -f 00 ${CY_APP_SS_DS_HEX} ${CY_APP_SS_BIN}"
if [ ${VERBOSE} -ne 0 ]; then
...
GEN_APP_DS_BIN_COMMAND="${CYWICEDTOOLS}/IntelHexToBin/IntelHexToBin -l ${DS_LOCATION} -f 00 ${CY_APP_SS_DS_HEX} ${CY_APP_DS_BIN}"
if [ ${VERBOSE} -ne 0 ]; then
