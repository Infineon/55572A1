...
#define APP_CFG_BT_BLE_HOST_TO_DEVICE_COUNT         8 //BT_BLE_HOST_TO_DEVICE_DEFAULT_COUNT
#endif
#ifndef APP_CFG_BT_BLE_DEVICE_TO_HOST_COUNT
#define APP_CFG_BT_BLE_DEVICE_TO_HOST_COUNT         8 //BT_BLE_DEVICE_TO_HOST_DEFAULT_COUNT
#endif
